...
<body>
    ...
    <div class="container">
        ...
        $sql = "SELECT pedidos.id, pedidos.numero_pedido, productos.nombre AS nombre_producto, pedidos.precio, pedidos.costo_envio, pedidos.total, pedidos.fecha_entrega, pedidos.usuario
                FROM pedidos
        ...
        if ($resultado->num_rows > 0) {
            ...
            echo "<thead class='thead-dark'><tr><th>Número de Pedido</th><th>Producto</th><th>Precio</th><th>Costo de Envío</th><th>Total</th><th>Fecha de Entrega</th><th>Usuario</th><th>Acciones</th></tr></thead>";
            echo "<tbody>";
            while ($fila = $resultado->fetch_assoc()) {
                ...
                echo "<td>$" . $fila["costo_envio"] . "</td>";
                echo "<td>$" . $fila["total"] . "</td>";
                echo "<td>" . $fila["fecha_entrega"] . "</td>";
                echo "<td>" . $fila["usuario"] . "</td>";
                echo "<td>";
                echo "<a href='editar_pedido.php?id=" . $fila["id"] . "' class='btn btn-info btn-sm'>Editar</a> ";
                echo "<a href='eliminar_pedido.php?id=" . $fila["id"] . "' class='btn btn-danger btn-sm'>Eliminar</a>";
                echo "</td>";
                echo "</tr>";
            }
            echo "</tbody>";
            ...
            echo "<div class='alert alert-info' role='alert'>No se encontraron pedidos.</div>";
        }
